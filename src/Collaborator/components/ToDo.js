  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        ...
        // Fetch tasks assigned to current user with status "To Do"
    ...
    <Box className="space-y-6">
      ...
      <Box className="mb-6">
        ...
        <Typography variant="body2" sx={{ color: '#64748b' }}>
          {filteredTasks.length} tasks waiting for your action
        </Typography>
      </Box>
      ...
      {loading ? (
        ...
        <Box sx={{ 
          ...
          <Typography variant="body2" sx={{ color: '#64748b', maxWidth: '400px', textAlign: 'center' }}>
            {searchTerm ? 'No tasks match your search criteria' : 'All caught up! Enjoy your free time or check other task statuses.'}
          </Typography>
          {!searchTerm && (
            <Button
              variant="outlined"
