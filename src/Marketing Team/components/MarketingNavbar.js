...
const MarketingNavbar = ({ drawerWidth, handleDrawerToggle }) => {
        ...
        <Toolbar sx={{ 
          ...
          <Box sx={{ 
            ...
            <div className="flex items-center space-x-2 ml-2">
              ...
              >
                <MenuItem onClick={() => window.location.href = `/marketing-team-dashboard/profile/${currentUser.username}`} sx={{ py: 1.5 }}>
                  <ListItemIcon>
                    <FiUser size={18} />
                  </ListItemIcon>
                  My Profile
