            ...
            <Paper className="p-4 mb-6">
              ...
              <div className="space-y-4">
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.leadUpdates || false}
                      onChange={() => handleNotificationToggle("leadUpdates")}
                      color="primary"
                    />
                  }
                  label="Lead updates and changes"
                />
                
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.dealProgress || false}
                      onChange={() => handleNotificationToggle("dealProgress")}
                      color="primary"
                    />
                  }
                  label="Deal progress notifications"
                />
                
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.systemAlerts || false}
                      onChange={() => handleNotificationToggle("systemAlerts")}
                      color="primary"
                    />
                  }
                  label="System alerts and updates"
                />
              </div>
            </Paper>
            ...
            <Paper className="p-4">
              ...
              <div className="space-y-4">
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.taskReminders || false}
                ...
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.meetingAlerts || false}
                      onChange={() => handleNotificationToggle("meetingAlerts")}
                      color="primary"
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Switch
                      checked={userData.notificationSettings?.performanceUpdates || false}
                      onChange={() => handleNotificationToggle("performanceUpdates")}
                      color="primary"
                    />
                  }
          ...
          <Box className="max-w-2xl mx-auto">
            ...
            <Paper className="p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <Typography variant="body1">May 15, 2025</Typography>
                </div>
                ...
                <div>
                  ...
                  <Typography variant="body1">$29.99/month</Typography>
                </div>
              </div>
              
              <Button variant="outlined" className="border-indigo-600 text-indigo-600 hover:bg-indigo-50">
            ...
            <Paper className="p-4">
              ...
              <div className="grid grid-cols-4 gap-4 items-center mb-3">
                ...
                <div>$29.99</div>
                <div><Chip label="Paid" color="success" size="small" /></div>
              </div>
