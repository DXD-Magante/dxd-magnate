...
import { doc, getDoc, updateDoc, collection, query, where, onSnapshot, serverTimestamp, orderBy, limit, getDocs } from "firebase/firestore";
...
const [projects, setProjects] = useState([]);
  ...
  <AdminSearch users={users} projects={projects} />
</Box>
