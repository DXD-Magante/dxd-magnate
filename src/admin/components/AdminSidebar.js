...
import { FiBook, FiCalendar, FiDollarSign, FiFileText, FiHome, FiLayers, FiSettings, FiShoppingCart, FiUsers } from "react-icons/fi";
...
const sections = [
  ...
  },
  {
    ...
    items: ["Revenue & Profit Analysis", "Billing & Invoices"]
  },
  {
    title: "Marketing Analytics",
    icon: <MdOutlineCampaign size={20} />,
    items: ["All Campaigns","Campaign Performance", "Lead Conversions", "SEO & Ad Metrics", "Schedule Posts"]
  },
  {
    title: "Sales & CRM",
  ...
  },
  {
    ...
    items: ["Clients Overview", "Admin & Team Roles", "Team Assignment", "Permissions & Access", "Monthly Target", "Forecast Management"]
  },
  {
    title:"Learnings",
    icon: <FiBook/>,
    items: ["Course Management", "Performance", "Feedback & Review's"]
  },
  {
