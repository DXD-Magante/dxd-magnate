...
const OngoingProjects = () => {
      ...
      try {
        ...
        const projectsData = querySnapshot.docs.map(doc => {
          ...
          return {
            ...
            client: data.clientName || data.company || "Unknown Client",
            team: data.teamMembers || [], // Change this line
            startDate: data.startDate || "",
            deadline: data.endDate || "",
            progress: calculateProgress(data.status),
            priority: data.priority ? capitalizeFirstLetter(data.priority) : "Medium",
            status: data.status ? capitalizeFirstLetter(data.status) : "Not started yet",
            manager: data.projectManager || "Not assigned",
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      alert(error)
      // You might want to add error handling here (e.g., show a notification to the user)
    }
  };
